...
//    Route::post('/login/regsendcode',                 'LoginController@regsendcode');//账户注册发送验证码
    ...
    //提现
    Route::post('/Mycenter/bank_info',                 'MycenterController@getBankInfo');//获取用户银行卡信息，是否需要绑定
    Route::post('/Mycenter/bank_bind',                 'MycenterController@firstBind');//用户绑定银行卡信息
    Route::post('/Mycenter/bank_update',               'MycenterController@updateBank');//用户修改银行卡信息
    Route::post('/Mycenter/draw_update',               'MycenterController@updateDrawPwd');//用户修改提现密码
